 ...
 * JSON DB START
 ===============================================================*/
const API_KEY = './json-db/api-key.json';
api = (fs.existsSync(API_KEY))?require(API_KEY):'';
let api_key = api.key;
const BASE_URL = './json-db/base.json';
base = (fs.existsSync(BASE_URL))?require(BASE_URL):'';
let base_url = base.url;

// const BROADCAST = './json-db/broadcast.json';
// bcast = (fs.existsSync(BROADCAST))?require(BROADCAST):'';
/**==============================================================
 * JSON DB END
 ===============================================================*/
